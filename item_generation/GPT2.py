...
def train_GPT2(model_name_or_path, train_data_file, output_dir, config_name=None, cache_dir=None, line_by_line=True, block_size=-1,
               overwrite_cache=False, overwrite_output_dir=False, do_train=False, per_gpu_train_batch_size=8,
               gradient_accumulation_steps=1, learning_rate=5e-5, weight_decay=0.0, adam_epsilon=1e-8, max_grad_norm=1.0,
               ...
               fp16_opt_level="O1", local_rank=-1, tpu_num_cores=None, tpu_metrics_debug=False, bos_token='<|endoftext|>'):
    """
    ...
    training_args = TrainingArguments(output_dir=output_dir, overwrite_output_dir=overwrite_output_dir, do_train=do_train,
                                      ...
                                      local_rank=local_rank, tpu_num_cores=tpu_num_cores, tpu_metrics_debug=tpu_metrics_debug)
    ...
    class ExtendedTrainer(Trainer):
        ...
        def _prediction_loop(self, dataloader: DataLoader, description: str,
